/**
 * @description 集中式 AI 模型配置 — 统一管理模型实例和 structuredOutputs 设置。
 *
...
/** 快��模型 — 词典回退、简单文本提取等低复杂度场景 */
export const modelFast = openai('gpt-5.4-mini');

/** 强力模型 — 作文批改、复习文章生成、AI 对话辅导等高复杂度场景 */
export const modelPower = openai('gpt-5.4');

/** 视觉模型 — OCR、图片识别（语义别名，当前与 modelPower 同款） */
export const modelVision = openai('gpt-5.4');
